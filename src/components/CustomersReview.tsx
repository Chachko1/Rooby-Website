...
const CustomersReview = () => {
  return (
    ...
    <div className='flex flex-col w-full lg:w-[90%] mx-auto '>
                ...
                <p className='font-inter font-medium text-[20px] lg:text-[30px] w-full  border-t border-gray-400 p-5 text-black'>The best thing we love about Yoora is it does two-way sync with Google Apps. It has helped us to better organize and keep everything on track.</p>
            ...
            <div className='flex flex-col w-full lg:w-[90%]  mx-auto'>
                 <div className="p-5 pb-8"><img src="GreenIcon.png" alt="" width={30} height={30} /> </div>
                <p className='font-inter font-medium text-[20px] lg:text-[30px] w-full  border-t border-gray-400 p-5 text-black'>It has made our sales department more effective and efficient. It’s easy to use and it’s constantly updated. It’s easy to use and it’s constantly updated.</p>
                <div className='flex gap-5 pt-5'>
            ...
            <div className='flex flex-col w-full lg:w-[90%] mx-auto'>
                 <div className="p-5 pb-8"><img src="GreenIcon.png" alt="" width={30} height={30} /> </div>
                <p className='font-inter font-medium text-[20px] lg:text-[30px] w-full  border-t border-gray-400 p-5 pb-[20px] lg:pb-[110px] text-black'>Easy to use, reasonably priced, and ensures I don’t drop the ball on following up with my leads!</p>
                <div className='flex gap-5 pt-5'>
