...
const Header = () => {
  return (
    <header className="">
        <div className="flex flex-col md:flex-row pt-10 pb-10 pl-10 bg-white justify-between">
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-0 bg-white justify-between w-[85%] mx-auto p-10 ">
            <p className="font-inter font-medium lg:pb-0 pb-5 lg:pl-0 pl-5">Trusted by 1,000+ customers</p>
