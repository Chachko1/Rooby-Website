  ...
  return (
    ...
    <section className="p-[20px] lg:p-[100px]">
        <div className="flex flex-col lg:flex-row  gap-2 border-t border-gray-400 p-[50px]">
            ...
            <div className="bg-customBlue py-[20px] lg:py-[50px] px-[30px] lg:px-[70px] rounded-2xl">
                <img src="Bitmap.png" alt="" className="rounded-2xl" />
            </div>

        </div>
    </section>
    <section className="pb-[25px] lg:pb-[100px] px-[25px] lg:px-[100px]">
        <div className="flex flex-col lg:flex-row gap-[70px] border-t border-gray-400 p-[50px]">
            
                <img src="Marketing.png" alt="" className="rounded-2xl"/>
           
            <div className="w-full lg:w-[50%] mx-auto pt-[5px] lg:pt-[70px]">
                <span className="bg-customYellow rounded-md p-1.5 px-2 font-inter font-bold text-xl">Marketing</span>
                <div className="font-inter font-bold  text-[32px] lg:text-[48px] py-4 lg:py-2 text-black">Marketing</div>
                <p className="font-inter text-[18px] w-full lg:w-[80%] py-2 text-black">Market like the most successful companies in the world with Agile CRM's marketing automation software.  </p>
                <ul className="font-inter p-2 text-[18px]">
    ...
    <section className="pb-[25px] lg:pb-[100px] px-[25px] lg:px-[100px]">
        <div className="flex flex-col lg:flex-row gap-2 border-t border-gray-400 p-[50px]">
            <div className="w-full lg:w-[50%] mx-auto pt-[20px] lg:pt-[70px]">
                <span className="bg-customYellow rounded-md p-1.5 px-2 font-inter font-bold text-xl">Service</span>
                <div className="font-inter font-bold text-[32px] lg:text-[48px] py-5 md:py-0 text-black">Help Desk Software</div>
                <p className="font-inter text-[18px] w-full lg:w-[70%]  text-black">Great customer support separates decent companies from excellent companies. A positive customer support experience is a crucially important piece of the customer journey. </p>
                <ul className="font-inter p-2 text-[18px] w-full lg:w-[90%]">
            ...
            <div className="bg-gray-100 py-[10px] lg:py-[45px] px-[15px] lg:px-[60px] rounded-2xl">
