    ...
    <section>
        ...
        <div className="flex flex-col md:flex-row mx-auto w-[80%]">
            <div className="p-5">
                ...
                <h1 className="font-inter font-bold text-[20px] lg:text-[32px] text-black">How To Deliver a Successful Product Launch</h1>
            ...
            <div className="p-5 ">
                ...
                <h1 className="font-inter font-bold text-[20px] lg:text-[32px] text-black">What Makes an Authentic Employee Profile, and Why Does It Matter?</h1>
