...
const WhatsNew = () => {
  return (
    <section>
        <div className="flex flex-col md:flex-row justify-center md:justify-between font-inter p-[25px] md:p-[100px] text-black"><h1 className="font-bold text-[35px] md:text-[64px]">What’s new at Roooby?</h1> <p className="font-medium text-[20px] pt-[65px]">See all <span className="text-customGreen">{'>'}</span></p></div>
