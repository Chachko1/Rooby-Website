...
const Section1 = () => {
  return (
   <section className="bg-customBlue flex flex-col">
    <div className="flex flex-col md:flex-row justify-center items-center pb-[50px] font-inter px-[100px] pt-[100px]">
    ...
    <div className="flex flex-col md:flex-row justify-center items-center gap-2 mx-auto p-[40px] md:p-[100px]">
